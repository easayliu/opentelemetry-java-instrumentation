...
public class OnsBatchConsumerInstrumentation implements TypeInstrumentation {

  @Override
  public ElementMatcher<TypeDescription> typeMatcher() {
    return named("com.aliyun.openservices.ons.api.impl.rocketmq.BatchConsumerImpl");
  }
  ...
  public void transform(TypeTransformer transformer) {
    transformer.applyAdviceToMethod(
        ...
        OnsBatchConsumerInstrumentation.class.getName() + "$StartAdvice");
  }

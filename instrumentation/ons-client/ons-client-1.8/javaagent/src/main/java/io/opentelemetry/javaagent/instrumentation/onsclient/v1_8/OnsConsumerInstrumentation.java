...
public class OnsConsumerInstrumentation implements TypeInstrumentation {

  @Override
  public ElementMatcher<TypeDescription> typeMatcher() {
    return named("com.aliyun.openservices.ons.api.impl.rocketmq.ConsumerImpl");
  }
  ...
  public void transform(TypeTransformer transformer) {
    transformer.applyAdviceToMethod(
        ...
        OnsConsumerInstrumentation.class.getName() + "$StartAdvice");
  }
